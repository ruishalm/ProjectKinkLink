    ...
    <div className={styles.section}>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          />
          <button type="submit" disabled={isLoading || !!successMessage} className={styles.primaryButton}>
      ...
      {!successMessage && ( // Só mostra o botão de cancelar se ainda não houve sucesso
        <button onClick={onCancel} className={styles.secondaryButton} disabled={isLoading}>
          Cancelar
        </button>
      )}
    </div>
